...
namespace MIDAS_BAT.Pages
{
    ...
    /// </summary>
    public sealed partial class LeftCrossLineTestPage : Page
    {
        ...
        public static string TEST_NAME = "leftCrossLineTest";
        public static string TEST_NAME_KR = "사선 따라그리기(왼쪽)";
        public static int TEST_ORDER = 3;

        public LeftCrossLineTestPage()
        {
        ...
        private async Task nextHandling()
        {
            try
            {
                ...
                points.Add(ttv.TransformPoint(new Point(leftCrossLine.X1, leftCrossLine.Y1)));
                points.Add(ttv.TransformPoint(new Point(leftCrossLine.X2, leftCrossLine.Y2)));
